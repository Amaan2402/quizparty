...
function UserRankCard({
  ...
  return (
    <div className="flex py-3 px-4 justify-between items-center gap-3 bg-[#3f3faf] rounded-xl shadow-md">
      ...
      <div className="bg-[#f7f7f7] rounded-lg p-2 flex flex-col items-center text-black">
